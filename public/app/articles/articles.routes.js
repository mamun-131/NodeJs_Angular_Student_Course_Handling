System.register(["./articles.component", "./create/create.component", "./list/list.component", "./view/view.component", "./viewByCourse/view.component", "./viewByStudent/view.component", "./edit/edit.component"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var articles_component_1, create_component_1, list_component_1, view_component_1, view_component_2, view_component_3, edit_component_1, ArticlesRoutes;
    return {
        setters: [
