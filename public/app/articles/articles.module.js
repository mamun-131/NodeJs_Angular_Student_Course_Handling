System.register(["@angular/core", "@angular/common", "@angular/forms", "@angular/router", "./articles.routes", "./articles.component", "./create/create.component", "./list/list.component", "./view/view.component", "./edit/edit.component", "./viewByCourse/view.component", "./viewByStudent/view.component"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, forms_1, router_1, articles_routes_1, articles_component_1, create_component_1, list_component_1, view_component_1, edit_component_1, view_component_2, view_component_3, ArticlesModule;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
